...
@Component({
  selector: 'app-canvas-001-languages',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule],
  templateUrl: './canvas-001-languages.component.html',
  styleUrls: ['./canvas-001-languages.component.css'],
})
export class Canvas001LanguagesComponent implements OnInit {
